...
\end{example}
	...
	\begin{example}
		...
		Let $\gamma'$ be a different proper ray. Let $B\subset X$ be any bounded set. Then $X\setminus B$ is connected. Since $\gamma, \gamma'$ are proper, there exist a $t, t'$, such that $\gamma[t, \infty)\subset X\setminus B$, and $\gamma'[t', \infty)\subset X\setminus B$. Now $t'' = max(t, t')$ shows $\gamma \sim \gamma'$.
